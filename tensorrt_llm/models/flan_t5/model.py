...
from tensorrt_llm.layers import (GatedMLP, Attention, AttentionMaskType,
...
class FlanT5EncoderLayer(Module):
    ...
    def forward(self,
        ...
        hidden_states = self.gated_mlp(hidden_states)
...
class FlanT5DecoderLayer(Module):
...
class FlanT5EncoderModel(Module):
...
class FlanT5DecoderModel(Module):
